package cn.mrray.raybaas.demo.contract;
...
import cn.mrray.raybaas.grpc.common.RpcReply;
import cn.mrray.raybaas.grpc.peer.ContractID;
import cn.mrray.raybaas.grpc.peer.SdkPeerRequest;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;

/***
 * 系统合约需要继承 BaseContract
 */
public class ContractImpl {
    ...
    public Response initAmount(ContractStub contractStub, ContractVo contractVo) {
        System.out.println("ContractImpl json串：" + contractVo.getData());
    ...
    public RpcReply invoke(SdkPeerRequest request) {
        return null;
    }
